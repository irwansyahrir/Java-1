...
public class Sha2Test
{
    ...
    public static void setUpClass()
    {
        ...
        vector[3] = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"
            .getBytes();
    ...
    public void TestSha224Vector1()
    {
        ...
        Assertions.assertEquals("message digests are not equal", digest, Sha2.SHA224(vector[0]));
    }
